                ...
                <div class="blist"  :class="bList.length>0?'true':''">
                  <div class="table">
                    ...
                    >
                      ...
                      <el-col :span="2">{{item.contactsName}}</el-col>
                      <el-col :span="3">{{item.contactsPhone}}</el-col>
                      <el-col :span="3">{{item.money}}</el-col>
                      <el-col :span="6">{{item.companyAddress}}</el-col>
                      <el-col :span="4">
...
import { mt_queryMyCustomer } from "@/api/my";
