          ...
          <div class="fr login_input">
            <div class="box">
              ...
              <div class="login_input_area">
                ...
                <div class="input">
                  <input type="password" placeholder="输入新密码，不低于6位" v-model="password" autocomplete="new-password">
                </div>
                <div class="input">
                  <input type="password" placeholder="确认新密码" v-model="password1" autocomplete="new-password"  @keyup.enter="register_but">
                </div>
