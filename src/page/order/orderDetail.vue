    ...
    <el-dialog
      ...
      <el-row>
        ...
        <div class="cont">
          ...
          <br />乙方：
          <span style="width:300px;display:inline-block;">{{contract.companyName}}</span>签约代表：{{contract.contactsName}}
          <br />
        ...
        <div>营业执照
          ...
          法人身份证复印件
          <img v-if="contract.imgs2" :src="contract.imgs2.positive" alt style="width:300px;" />
