        ...
        <div class="newInfomation">
          <!-- <div class="welcome">
            ...
            <div class="info">
              ...
              <div class="opt" v-if="isLogin">
                <div class="u">用户-{{userInfo.nickName}}</div>
              </div>
            </div>
          </div>
          <div class="contact" :class="phoneInfo.list.length>1?'small':''" v-if="phoneInfo.list">
            ...
            <div class="tel">
              <div
                class="itm"
                v-for="(item,index) of phoneInfo.list"
                :key="index"
    ...
    <div class="mobile" v-if="mobileMode.result">
      ...
      <div class="navBox">
        <swiper :options="swiperOption">
          <swiper-slide v-for="item of swiperList" :key="item.id">
            ...
            <div v-if="item.jumpType==2" @click="viewDetail(item.record.id)" class="clk"></div>
            <div v-if="item.jumpType==1" @click="jump(item.record)" class="clk"></div>
          </swiper-slide>
          <div class="swiper-pagination" slot="pagination"></div>
        </swiper>
      </div>
      ...
      <div class="sortBox">
        <div class="box">
          <div class="title">
            <span>{{sortList.typeStr}}</span>
            <img src="/static/icon_m/sort.png">
          </div>
          <div class="imgs">
            <swiper :options="swiperOption1">
              <swiper-slide v-for="item of sortList.goodsList" :key="item.id">
                <div class="img">
                  <img :src="item.img" />
                </div>
      ...
      <div class="productBox"
        ...
        <div class="box">
          <div class="title">
            <span>{{item.typeStr}}</span>
            <img src="/static/icon_m/hot.png"></img>
          </div>
          <div class="list">
            <div class="itm" 
            v-for="(items,indexs) of item.goodsList"
            ...
            @click="viewDetail(items.id)">
              ...
              <div class="des ellipsis2">{{items.name}}</div>
              <div class="price">￥{{items.money}}</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    search() {
      this.$router.push({
        name: "list",
        params: { name: this.wordkey, menuId: "" }
      });
    },
